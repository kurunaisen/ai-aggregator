...
export function DeaiCostHint({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center gap-1.5 rounded-xl border px-3 py-2 transition-colors ${
        canAfford
      ...
      title={`Списание Deai · режим ${mode === "token" ? "токены" : "кредиты"}`}
    >
