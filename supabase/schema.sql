...
insert into public.tools (slug, name, tagline, description, long_description, category, pricing, website, featured, tags, features, published) values
  ...
  ('monaco', 'Monaco Editor', 'Редактор кода с AI', 'Monaco — движок VS Code в браузере на DeltaplanAI.', 'Monaco Editor на DeltaplanAI: подсветка синтаксиса, языки программирования и AI-помощник для кода.', 'code', 'freemium', 'https://microsoft.github.io/monaco-editor/', true, array['код','ide','monaco'], array['Monaco','AI по коду'], true),
