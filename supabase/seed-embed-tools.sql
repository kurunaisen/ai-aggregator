...
insert into public.tools (
  ...
  (
    ...
    'Grok',
    'AI-ассистент от xAI',
    'Grok на DeltaplanAI — чат с Grok 3 от xAI: тексты, идеи, код и анализ.',
    'Текст',
    'text',
    'freemium',
    'https://x.ai',
  ...
  (
    ...
    'Grok Imagine на DeltaplanAI — генерация изображений от xAI. Модели Imagine и Imagine Quality, разрешение 1K/2K.',
    'Изображения',
    'image',
    'freemium',
  ...
  (
    ...
    'Nano Banana на DeltaplanAI — модели Gemini Image: 2.5 Flash, 3.1 Flash и 3 Pro. Генерация изображений по текстовому описанию.',
    'Изображения',
    'image',
    'freemium',
  ...
  (
    ...
    'FLUX на DeltaplanAI — модели FLUX.2 Pro и Klein от Black Forest Labs. Фотореалистичная генерация по описанию.',
    'Изображения',
    'image',
    'freemium',
  ...
  (
    ...
    'Google Veo на DeltaplanAI — модели Veo 3.1, Fast и Lite. Текст, изображение или Ingredients to Video.',
    'Видео',
    'video',
    'freemium',
  ...
  (
    ...
    'Kling на DeltaplanAI — text-to-video от Kling AI: модели 2.6, 2.5 Turbo и 2.1 Master.',
    'Видео',
    'video',
    'freemium',
    'https://klingai.com',
