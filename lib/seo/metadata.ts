...
export function buildRootMetadata(): Metadata {
  ...
  return {
    ...
    description:
      "Найдите лучшие нейросети для текста, изображений, кода, видео и аудио. Актуальный каталог AI-инструментов с описаниями и категориями.",
    openGraph: {
      type: "website",
      locale: "ru_RU",
      siteName: SITE_NAME,
      ...
      description:
        "Найдите лучшие нейросети для текста, изображений, кода, видео и аудио.",
      url: siteUrl,
    },
    twitter: {
      card: "summary_large_image",
